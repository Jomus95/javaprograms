...
public class MyMath {
     ...
     * генерирует матрицу с рандомными значениями от 0 до 10,
    ...
    /**
     * Задача 1.4
     * Метод меняет местами первую и вторую ячейку в массиве,
    ...
    /**
     * Arrays.copyOfRange − копирует часть массива;
     */
}
